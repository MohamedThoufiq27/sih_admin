...
const Dashboard = ({ filteredReports, handleReportResolve, setIsFiltering, searchTerm, setSearchTerm ,user ,role}) => {
        ...
        <>
          ...
          <div className="max-w-7xl mx-auto mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2"><AnalyticsDashboard user={user} role={role}/></div>
              <div className="lg:col-span-1"><AnalyticsPieChart user={user} role={role}/></div>
            </div>
          </div>
        </>
      )}
